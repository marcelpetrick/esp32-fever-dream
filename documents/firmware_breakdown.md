...
Last measured: 2026-06-27 from ESP-IDF build output for firmware `0.0.30`,
...
| `web/app.js` | `33,688 B` |
| **Total web payload** | **`49,414 B`** |

The complete app image is `50,848 B` larger than firmware `0.0.21`; that delta
