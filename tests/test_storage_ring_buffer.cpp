...
void TestStorageRingBuffer() {
    ...
    REQUIRE(buffer.Append(fever::ReadingRecord::Success(
        10U, {700U, 40U, 100U, 2100, 41U}, fever::ConfidencePercent{95U}, fever::ReadingFlags::kRecognitionRuleBased)));
    REQUIRE(buffer.Append(fever::ReadingRecord::Success(
        20U, {710U, 41U, 101U, 2110, 42U}, fever::ConfidencePercent{96U}, fever::ReadingFlags::kRecognitionRuleBased)));
    ...
    REQUIRE(buffer.Append(fever::ReadingRecord::Success(
        40U, {720U, 42U, 102U, 2120, 43U}, fever::ConfidencePercent{97U}, fever::ReadingFlags::kRecognitionRuleBased)));
    REQUIRE(buffer.Full());
